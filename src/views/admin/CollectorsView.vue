          ...
          <div v-if="!editMode && !viewMode">
            ...
            <div class="relative">
              <input v-model="form.password" :type="showPassword ? 'text' : 'password'" 
                ...
                class="w-full px-5 py-3 pr-12 bg-slate-50 dark:bg-slate-900/50 border rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all dark:text-white font-medium" placeholder="••••••••">
            ...
            <div>
              ...
              <div class="relative">
                <input v-model="form.old_password" :type="showPassword ? 'text' : 'password'" 
                  class="w-full px-5 py-3 pr-12 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/50 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all dark:text-white font-medium" placeholder="••••••••">
              </div>
            </div>
